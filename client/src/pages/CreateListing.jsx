        ...
        <h1 className='text-3xl font-semibold text-center my-7'>Create a Listing</h1>
            ...
            <form className="flex flex-col sm:flex-row gap-4">
                <div className='flex flex-col gap-4 flex-1'>
                    ...
                    <input type="text" placeholder='Description' className='boder p-3 rounded-lg' id='description' required/>

                    <input type="text" placeholder='adress' className='boder p-3 rounded-lg' id='adress' required/>
                ...
                <div className='flex flex-col flex-1 gap-4'>
                    ...
                    <div className='flex gap-4'>
                        <input className='p-3 border border-gray-300 rounded w-full cursor-pointer' type="file" id='image' accept='image/*' multiple/>
                        <button className='p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80'>upload</button>
                    </div>
                    <button className='p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-95 disabled:m-80'>Create Listening</button>
                </div>
